...
class CasaStockHananeChangePriceWizard(models.TransientModel):
    _name = 'casa_hanane.stock.change.price.wizard'
    _description = 'Changer le Prix d\'Achat du Stock Hanane'

    stock_id = fields.Many2one('casa_hanane.stock.stock', string='Ligne de Stock', required=True, readonly=True)
    product_id = fields.Many2one('casa_hanane.product', related='stock_id.product_id', string='Produit', readonly=True)
    ...
    def action_confirm(self):
        ...
        self.env['casa_hanane.stock.move'].create({
