...
class ClaimsQuantity(models.Model):
    _name = 'claims.quantity'
    _description = 'Quantity Claim'
    ...
    def action_print_report(self):
        ...
        return self.env.ref('claims.action_report_claims_quantity').report_action(self)
    ...
    document_ids = fields.Many2many(
        'ir.attachment',
        'claims_quantity_attachment_rel',
        'claim_id',
        'attachment_id',
