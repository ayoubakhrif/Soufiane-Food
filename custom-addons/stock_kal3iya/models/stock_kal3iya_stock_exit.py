...
class StockKal3iyaExit(models.Model):
    _name = 'stock.kal3iya.exit'
    ...
    def create(self, vals):
        if vals.get('name', '/') == '/':
            vals['name'] = self.env['ir.sequence'].next_by_code('stock.kal3iya.exit') or '/'
        return super(StockKal3iyaExit, self).create(vals)
    ...
    def write(self, vals):
        ...
        return super(StockKal3iyaExit, self).write(vals)
