...
class TransportTrip(models.Model):
    ...
    is_charge_fuel_unpaid = fields.Boolean(string='Non payé', default=False, tracking=True)
    charge_driver = fields.Float(string='Déplacement Chauffeur', tracking=True)
    is_charge_driver_unpaid = fields.Boolean(string='Non payé', default=False, tracking=True)
